...
<div class="container-header">
      ...
      <div id="div2">
          ...
          <div class="content">
            ...
            <ul class="menu-list">
            <li>
            <a href="${mainUrl2}./pages/Noutati/noutati.html" class="lang-element ro" style="margin-right: 15px;">Noutăți</a>
            <a href="${mainUrl2}./pages/Noutati/noutati.html" class="lang-element en" style="display: none; margin-right: 15px;">News</a>
            <a href="${mainUrl2}./pages/Noutati/noutati.html" class="lang-element ru" style="display: none; margin-right: 15px;">Новости</a>
            </li>
              ...
              <span class="log-site"><li>
                  <div id="dropdown3" class="dropdown3">
                    ...
                    <a class="links" href="${mainUrl2}./pages/Activitati/generale.html">
                        <span class="lang-element ro">Activități</span>
                        <span class="lang-element en" style="display: none;">Activity</span>
                        <span class="lang-element ru" style="display: none;">Активность</span>
                      </a>
